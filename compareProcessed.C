...
//TCanvas *Canvas_1 = (TCanvas*)f1.Get("Canvas_1");
//f1h1 = (TH1D*)Canvas_1->GetPrimitive("hNumTubesHit");
//f1h2 = (TH1D*)Canvas_1->GetPrimitive("hNumTubesDigiHit");
//f1h3 = (TH1D*)Canvas_1->GetPrimitive("hSumQ");
//f1h4 = (TH1D*)Canvas_1->GetPrimitive("hCerHitTimes");

  TH1D *f1h1 = (TH1D*)f1->GetPrimitive("hNumTubesHit");
  TH1D *f1h2 = (TH1D*)f1->GetPrimitive("hNumTubesDigiHit");
  TH1D *f1h3 = (TH1D*)f1->GetPrimitive("hSumQ");
  TH1D *f1h4 = (TH1D*)f1->GetPrimitive("hCerHitTimes");
...
TCanvas *Canvas_1 = (TCanvas*)f2.Get("Canvas_1");
//f2h1 = (TH1D*)Canvas_1->GetPrimitive("hNumTubesHit");
//f2h2 = (TH1D*)Canvas_1->GetPrimitive("hNumTubesDigiHit");
//f2h3 = (TH1D*)Canvas_1->GetPrimitive("hSumQ");
//f2h4 = (TH1D*)Canvas_1->GetPrimitive("hCerHitTimes");

  TH1D *f2h1 = (TH1D*)f2->GetPrimitive("hNumTubesHit");
  TH1D *f2h2 = (TH1D*)f2->GetPrimitive("hNumTubesDigiHit");
  TH1D *f2h3 = (TH1D*)f2->GetPrimitive("hSumQ");
  TH1D *f2h4 = (TH1D*)f2->GetPrimitive("hCerHitTimes");
